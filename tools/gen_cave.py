...
# il pipistrello: due frame di battito (nero sul fondo indaco)
BAT1 = ['..##........##..',
        '.####......####.',
        '.#####....#####.',
        '..####*..####...'.replace('*', '#'),
...
# la MANO che spazza il pavimento: dorso bombato e DITA che
# artigliano - due frame alternati: brancola come un cieco
HAND_L = ['................',
          '................',
          '................',
          '................',
...
def main():
    ...
    for art in seq + [HAND_L, HAND_R, BAT1, BAT2]:
        data = sprite16(art)
